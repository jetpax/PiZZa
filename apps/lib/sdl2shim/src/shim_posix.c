 ...
 * lives in s2s_assets.c over the embedded pack; this file carries
...
/* Doom renames a temp savegame onto the final name (G_DoSaveGame); the
 * store is read-only, so this fails cleanly and the game reports it.
 */
